...
/// {@template toy_figurines_page}
/// A page displaying toy and figurine products retrieved from Firestore.
///
/// Features:
...
class ToyFigurinesPage extends StatefulWidget {
  ...
  /// Stores all toy/figurine items globally for reuse.
...
class _ToyFigurinesPageState extends State<ToyFigurinesPage> {
  /// All toy/figurine items loaded from Firestore.
  ...
  /// Selected toy types for filtering.
  ...
  /// Loads toy/figurine products from Firestore and filters by category.
  ...
  /// Returns the filtered list of items based on selected characters and toy types.
  ...
  /// Builds the filter sidebar UI with character groups and toy types.
